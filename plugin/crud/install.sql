-- ============================================================
-- CRUD 插件核心表结构（认证 + RBAC + 菜单 + CRUD 配置）
--
-- 执行方式（推荐，幂等可重复执行）：
--   php plugin/crud/install.php
--   或调用 \plugin\crud\api\Install::install()
--
...
CREATE TABLE IF NOT EXISTS `crud_configs` (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='CRUD页面配置表';
--SPLIT--
