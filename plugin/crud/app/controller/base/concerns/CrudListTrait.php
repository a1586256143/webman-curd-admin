 ...
 * 依赖 CrudConfigTrait（config/grid/columns...）与 CrudQueryTrait（query/tableColumns...）。
 */
trait CrudListTrait
{
    /**
     * 输出前端 CRUD 配置（供 dynamicCrud 渲染）
     */
    ...
    protected function modelName(): string
    {
        ...
        $table = $this->table();
        return \plugin\crud\app\ModelRegistry::tableNameToModelName($table);
    }
