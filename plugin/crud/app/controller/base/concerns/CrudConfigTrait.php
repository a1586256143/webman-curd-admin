...
trait CrudConfigTrait
{
     ...
     * 实现后 table() 自动从模型取，CRUD 全程 Eloquent ORM
     */
    ...
    /**
     * 获取当前 CRUD 实际使用的模型：优先 Grid::model()，否则回退到控制器 model()。
     */
     ...
     *
     *   protected function grid(): \plugin\crud\app\dsl\Grid
     *   {
     *       return (new \plugin\crud\app\dsl\Grid('包管理'))
    ...
    /**
     * 自定义 API 路由前缀（默认 /api/crud/{table} 通配）
