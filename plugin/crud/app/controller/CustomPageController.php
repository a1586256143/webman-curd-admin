...
use plugin\crud\app\schema\PageRegistry;
use support\Request;
 ...
 * plugin/crud/config/route.php，随插件自动加载；/api/custom/* 仅登录即可。
 */
class CustomPageController
{
    ...
    {
        // 宿主业务 .vue 页面目录约定，随 config/plugin/crud/crud.php 可调
        return (string)config('plugin.crud.crud.vue_pages_dir', base_path() . '/app/custom/pages');
    }
