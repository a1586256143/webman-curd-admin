<?php
/**
 * 接口加解密配置（CURD 插件核心能力，读取路径 config('plugin.curd.crypto.*')）
 *
 ...
 *
 * 归属：中间件类 plugin/curd/app/middleware/ApiCrypto.php、
 *       私钥 plugin/curd/config/keys/api_rsa_private.pem 与本文件同属插件；
